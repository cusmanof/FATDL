<?php
	...
	function save($workspace, $selectedCategory, $list1, $list2, $list3, $list4) {
		...
		$list1 = prepSqlValue(addslashes($list1));
		$list2 = prepSqlValue(addslashes($list2));
		$list3 = prepSqlValue(addslashes($list3));
		$list4 = prepSqlValue(addslashes($list4));
	...
	function getWorkspaces() {
		...
		$searchSql = "SELECT * FROM workspaces";
		$searchResult = mysql_query($searchSql) or terminateWithError(500, "Error in SQL : " . $searchSql);
