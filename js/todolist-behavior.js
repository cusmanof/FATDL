 ...
 */
AnotherTodoList.public = 'public';

/**
 * Default selected category
 */
AnotherTodoList.user = null;
...
AnotherTodoList.save = function (e) {
    ...
    if ($F('workspace')) {
        ...
        new Ajax.Request('php/save.php', {
            method: 'post',
            parameters: {workspace: $F('workspace'), user: AnotherTodoList.user,
    ...
    if ($F('workspace')) {
        ...
        new Ajax.Request('php/load.php', {
            ...
            onSuccess: function (xhr) {
                ...
                AnotherTodoList.user = workspace.user;
...
AnotherTodoList.initApplicationIfNoCategoryAreDefined = function () {
    AnotherTodoList.user = AnotherTodoList.public;
    AnotherTodoList.selectCategory();
}


/**
 * Select the category according to AnotherTodoList.user.
 */
AnotherTodoList.selectCategory = function () {
    if (!AnotherTodoList.user) {
        AnotherTodoList.display(i18n.user, "error");
        return;
    }
